...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `RemoteStorageCIFS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RemoteStorageCIFS` (
  ...
  `windowsShare` varchar(255) DEFAULT NULL,
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK670F446848A2BFE1` (`id`),
  CONSTRAINT `FK670F446848A2BFE1` FOREIGN KEY (`id`) REFERENCES `RemoteStorage` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `RemoteStorageDFS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RemoteStorageDFS` (
  ...
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK2C9D68BC48A2BFE1` (`id`),
  CONSTRAINT `FK2C9D68BC48A2BFE1` FOREIGN KEY (`id`) REFERENCES `RemoteStorage` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `SourceDomainName`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SourceDomainName` (
  ...
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK6DBC240A1955299D` (`id`),
  CONSTRAINT `FK6DBC240A1955299D` FOREIGN KEY (`id`) REFERENCES `Item` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
