...
CREATE TABLE `EndpointStatus` (
  ...
  `discoverInProg` bit(1) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `endpointAliasIndex` (`endpointAlias`),
...
CREATE TABLE `IncidentLogFile` (
  ...
  KEY `FKDAB6258ED0CBCEBB` (`blueprint_id`),
  ...
  CONSTRAINT `FKDAB6258ED0CBCEBB` FOREIGN KEY (`blueprint_id`) REFERENCES `IncidentLogFileBlueprint` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `IncidentLogFileBlueprint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `MatchingDetail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MatchingDetail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `matcherFunc` varchar(255) DEFAULT NULL,
  `matchingData` longtext,
  `incidentLogFile_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKD364CACE72F76A2B` (`incidentLogFile_id`),
  CONSTRAINT `FKD364CACE72F76A2B` FOREIGN KEY (`incidentLogFile_id`) REFERENCES `IncidentLogFile` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `TemporaryAccessToken`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TemporaryAccessToken` (
  ...
  `serviceParam` varchar(255) DEFAULT NULL,
  `tokenKey` varchar(32) NOT NULL,
  `username` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tokenKey` (`tokenKey`),
  KEY `tokenKeyIndex` (`tokenKey`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
