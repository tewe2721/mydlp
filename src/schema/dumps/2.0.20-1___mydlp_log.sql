...
CREATE TABLE `MatchingDetail` (
  ...
  `matchingData` varchar(255) DEFAULT NULL,
  `incidentLog_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKD364CACE5A33480B` (`incidentLog_id`),
  CONSTRAINT `FKD364CACE5A33480B` FOREIGN KEY (`incidentLog_id`) REFERENCES `IncidentLog` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
