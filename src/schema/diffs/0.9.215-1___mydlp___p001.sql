...
ALTER TABLE AuthUser ADD COLUMN emailHashCode INT(11) NOT NULL COMMENT '', ADD COLUMN role_id INT(11) NOT NULL COMMENT '', ADD CONSTRAINT emailHashCode UNIQUE KEY(emailHashCode), ADD INDEX FK59398DB3A1D94A11 (role_id);
