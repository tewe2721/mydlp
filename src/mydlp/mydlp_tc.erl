...
get_text(Filename, ?MIME_PDF, <<"%PDF-1.", _:8/integer, "\n%",16,49,16,50,16,51,16,52,"\n% This file was generated by pdftopdf\n", _/binary>> = Data) -> %Fix for cups-pdf format
	?ERROR_LOG("Cups PDF Format get text is called.", []),
